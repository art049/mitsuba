 ...
 * of \ref DOSPPMParticleTracer with overridden functions
 * \ref ParticleTracer::handleSurfaceInteraction and
 * \ref DOSPPMParticleTracer::handleMediumInteraction.
 *
 * \ingroup librender
 */
class MTS_EXPORT_RENDER DOSPPMParticleProcess : public ParallelProcess {
public:
...
protected:
	 ...
	 */
	DOSPPMParticleProcess(EMode mode, size_t workCount,
 ...
 * \ingroup librender
 */
class MTS_EXPORT_RENDER DOSPPMParticleTracer : public WorkProcessor {
public:
	// =============================================================
...
protected:
	...
	DOSPPMParticleTracer(int maxDepth, int rrDepth, bool emissionEvents);
	/// Protected constructor
	DOSPPMParticleTracer(Stream *stream, InstanceManager *manager);
	/// Virtual destructor
	virtual ~DOSPPMParticleTracer() { }
protected:
	ref<Scene> m_scene;
